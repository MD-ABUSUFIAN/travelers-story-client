    ...
    return (
        <div className='login-bg'>
           ...
           <div className='w-100 mx-auto pt-5' >
                ...
                <h1 className='text-center fw-bolder text-danger'>REGISTER</h1>
                    ...
                    <input className='w-100 m-1 rounded py-3' {...register("password1")} type="password" placeholder='Write Your Password' required/>
                    <br/>
